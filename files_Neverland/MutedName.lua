...
database:sadd(bot_id.."Neverland:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Neverland:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."Neverland:blocname"..msg.chat_id_) or ""
